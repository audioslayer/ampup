...
public partial class App : Application
{
    ...
    private void ExportFxIconsAndExit()
    {
        ...
        (AmpUp.Core.Models.LightEffect Effect, string Stub)[] effects =
        {
            ...
            (AmpUp.Core.Models.LightEffect.BlackHole,     "blackhole"),
            (AmpUp.Core.Models.LightEffect.LavaLamp,      "lavalamp"),
            (AmpUp.Core.Models.LightEffect.Bubbles,       "bubbles"),
            (AmpUp.Core.Models.LightEffect.FractalMotion, "fractalmotion"),
            (AmpUp.Core.Models.LightEffect.NoiseMap,      "noisemap"),
            (AmpUp.Core.Models.LightEffect.MovingPanes,   "movingpanes"),
            (AmpUp.Core.Models.LightEffect.Sunrise,       "sunrise"),
            (AmpUp.Core.Models.LightEffect.Shimmer,       "shimmer"),
            (AmpUp.Core.Models.LightEffect.SpotsFade,     "spotsfade"),
            (AmpUp.Core.Models.LightEffect.StreamDual,    "streamdual"),
